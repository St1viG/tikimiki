...
const M = {
  ...
  body:       { en: "The user will be sent an official warning. Repeated violations may lead to account suspension by an administrator.",           sr: "Korisniku će biti poslato zvanično upozorenje. Ponovljeni prekršaji mogu dovesti do suspenzije naloga od strane administratora." },
