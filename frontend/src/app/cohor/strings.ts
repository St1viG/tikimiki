...
export const M = {
  ...
  kanbanAddColumn: { en: "Add column", sr: "Dodaj kolonu" },
  kanbanColumnNamePh: { en: "Column name", sr: "Naziv kolone" },
  kanbanRenameColumn: { en: "Click to rename", sr: "Klikni za preimenovanje" },
  kanbanDeleteColumn: { en: "Delete column", sr: "Obriši kolonu" },
  kanbanDeleteColumnConfirm: {
    en: "Click again to confirm — tasks move to the first column",
    sr: "Klikni ponovo da potvrdiš — zadaci se premeštaju u prvu kolonu",
  },
  kanbanUnassigned: { en: "— Unassigned —", sr: "— Nije dodeljeno —" },
  kanbanAssignAria: { en: "Assign to team member", sr: "Dodeli članu tima" },
  kanbanRenameCard: { en: "Click to rename", sr: "Klikni za preimenovanje" },
