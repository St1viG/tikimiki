        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="auth-two-col">
            <div className="auth-field">
              <label className="auth-label" htmlFor="first-name">{t("firstName")}</label>
              <input className="auth-input" id="first-name" type="text" placeholder="John" />
            </div>
            <div className="auth-field">
              <label className="auth-label" htmlFor="last-name">{t("lastName")}</label>
          ...
          <div className="auth-terms">
            <label className="auth-checkbox-label">
              ...
              <span>
                {t("termsAgree")} <a href="#">{t("termsOfUse")}</a> {t("and")} <a href="#">{t("privacyPolicy")}</a>.
              </span>
            </label>
            <div
              className={`auth-error-msg${termsError ? " visible error" : ""}`}
              id="terms-msg"
            >
