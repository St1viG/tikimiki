...
const M = {
  ...
  heroSub:           { en: "Advanced personalisation, more mini-games and exclusive benefits for serious competitors.", sr: "Naprednija personalizacija, češće mini igre i ekskluzivni benefiti za ozbiljne takmičare." },
  ...
  featAdvancedProfile: { en: "Advanced profile personalisation",                          sr: "Napredna personalizacija profila" },
  featMoreGames:     { en: "More frequent mini-game plays",                               sr: "Češće igranje mini igara" },
  featActivation:    { en: "Activation via account settings",                             sr: "Aktivacija putem podešavanja naloga" },
  featDuration:      { en: "Defined duration + auto-renewal",                             sr: "Definisan period trajanja + automatska obnova" },
  featBadge:         { en: "Exclusive Premium badge on profile",                          sr: "Ekskluzivna Premium bedž oznaka na profilu" },
  ...
  activateError:     { en: "Couldn't activate Premium. Please try again.",                sr: "Aktivacija Premiuma nije uspela. Pokušaj ponovo." },
  ...
  faqA0:             { en: 'You activate Premium through the dedicated screen in your account settings, or directly by clicking the "Activate Premium" button here.', sr: 'Premium aktiviraš putem namenskog ekrana unutar podešavanja naloga, ili direktno klikom na "Aktiviraj Premium" dugme ovde.' },
  faqQ1:             { en: "Can I cancel before the period ends?",                        sr: "Mogu li otkazati pre kraja perioda?" },
  faqA1:             { en: "You can cancel at any time. Premium remains active until the end of the paid period, after which it will not auto-renew.", sr: "Možeš otkazati u bilo kom trenutku. Premium ostaje aktivan do kraja plaćenog perioda, nakon čega se neće automatski obnoviti." },
  faqQ2:             { en: "What does advanced profile personalisation mean?",             sr: "Šta znači napredna personalizacija profila?" },
  faqA2:             { en: "Premium users can set animated banner images, custom profile colours, highlight up to 6 hackathons in their bio section, and display exclusive badge labels.", sr: "Premium korisnici mogu postavljati animovane banner slike, prilagođene boje profila, istaknuti do 6 hackathona u bio sekciji i prikazivati ekskluzivne bedž oznake." },
  faqQ3:             { en: "Is there a difference between the monthly and annual plan?",   sr: "Da li postoji razlika između mesečnog i godišnjeg plana?" },
  ...
  faqA3:             { en: "All Premium features are identical. With the annual plan you save {save}% compared to monthly payments. You are billed {annual} once a year instead of {monthly} every month.", sr: "Sve Premium funkcije su identične. Godišnjim planom uštediš {save}% u poređenju sa mesečnim plaćanjem. Naplaćuje se {annual} jednom godišnje umesto {monthly} svaki mesec." },
} as const;
...
export function PremiumClient() {
  ...
  const premiumPrice = priceAmount(
    isAnnual ? PRICING.annualPerMonth : PRICING.monthly,
  );
      ...
      <main className="premium-page" id="main">
        ...
        <div className="page-head">
          ...
          <div className="col-titles">
            <h1 className="page-title"><Icon name="premium" /> Premium</h1>
        ...
        <div className="billing-toggle">
          <span id="lbl-monthly" className={isAnnual ? "muted" : "active"}>{t("billingMonthly")}</span>
          <button
          ...
          <span id="lbl-annual" className={isAnnual ? "active" : ""}>{t("billingAnnual")}</span>
        ...
        <div className="plans-grid">
          ...
          <div className="plan-card">
            ...
            <div className="plan-price">
              ...
              <span className="plan-price-amount" id="price-basic">0</span>
              <span className="plan-price-period">{t("planPeriod")}</span>
            </div>
            <div className="plan-price-annual" id="note-basic">&nbsp;</div>

            <div className="plan-divider"></div>

            <ul className="plan-features">
              <li><span className="feat-check"><Icon name="check" /></span> {t("featHackathon")}</li>
              <li><span className="feat-check"><Icon name="check" /></span> {t("featBasicProfile")}</li>
              <li><span className="feat-check"><Icon name="check" /></span> {t("featDailySpin")}</li>
              <li><span className="feat-check"><Icon name="check" /></span> {t("featDailyMini")}</li>
              <li><span className="feat-check"><Icon name="check" /></span> {t("featMessages")}</li>
            </ul>
          ...
          <div className="plan-card featured">
            ...
            <div className="plan-price">
              ...
              <span
                key={flashKey}
                className="plan-price-amount flash"
                id="price-premium"
              >
                {premiumPrice}
              </span>
              ...
              {isAnnual ? (
                <>
                  <span className="strike">
                    {priceLabel(PRICING.monthlyAnnualized)}
                  </span>
                  {" → "}
                  <span className="save">
            ...
            <ul className="plan-features">
              <li><span className="feat-check"><Icon name="check" /></span> {t("featEverythingBasic")}</li>
              <li>
                <span className="feat-check"><Icon name="check" /></span>
                <span>{t("featAdvancedProfile")} <span className="feat-new">{t("featNew")}</span></span>
              </li>
              <li>
                <span className="feat-check"><Icon name="check" /></span>
                <span>{t("featMoreGames")} <span className="feat-new">{t("featNew")}</span></span>
              </li>
              <li>
                <span className="feat-check"><Icon name="check" /></span>
          ...
          <table className="compare-table">
            ...
            <tbody>
              <tr>
                ...
                <td><span className="check-yes"><Icon name="check" /></span></td>
                <td><span className="check-crystal"><Icon name="check" /></span></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><span className="check-yes">{t("rowBasicAdv")}</span></td>
                <td><span className="check-crystal">{t("rowAdvanced")}</span></td>
              </tr>
              <tr>
                <td>{t("rowDailySpin")}</td>
                <td><span className="check-yes">{t("rowSpinBasic")}</span></td>
                <td><span className="check-crystal">{t("rowSpinPremium")}</span></td>
              </tr>
              <tr>
